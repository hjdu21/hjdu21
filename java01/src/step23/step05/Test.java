...
=>호출할 메서드의 시그너처가 정의되었기 때문에 일관된 프로그래밍이 가능하다.
...
#추상 클래스
=>추상 클래스는 서브 클래스의 공통 필드나 메서드를 상속해 주기 위한 공통 용도이다.
=>추상 클래스에서 추상 메서드의 의미는 서브 클래스에게
메서드의 구현을 강제하는 문법일 뿐이다.
*/
